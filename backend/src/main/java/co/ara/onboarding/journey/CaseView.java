...
/**
 * Carries every field {@link UpdateCaseRequest} accepts -- the ownership triple and
 * the attribute answers -- per CLAUDE.md's full-replace invariant. The plan's own
